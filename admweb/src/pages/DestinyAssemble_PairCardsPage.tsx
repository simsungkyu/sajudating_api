// 궁합 카드 목록 페이지: /destiny_assemble/pair, 필터·카드 리스트.
...
export default function DestinyAssemble_PairCardsPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-xl font-semibold tracking-tight">명리어셈블 - 궁합 카드</h1>
      <Card>
        <CardContent className="pt-6 flex flex-col gap-4">
          ...
          />
          <CardList scope="pair" input={input} onOffsetChange={setOffset} pageSize={pageSize} onPageSizeChange={setPageSize} />
        </CardContent>
      </Card>
    </div>
  );
